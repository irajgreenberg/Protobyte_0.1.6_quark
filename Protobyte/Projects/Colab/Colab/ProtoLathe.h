...
namespace ijg {
	...
	inline void ProtoLathe::setRingRadius(float ringRadius) {
		this->ringRadius = ringRadius;
		update();
	}

	inline float ProtoLathe::getRingRadius() const {
		return ringRadius;
	}

	inline void ProtoLathe::setRingDetail(int ringDetail) {
		this->ringDetail = ringDetail;
		update();
	}

	inline int ProtoLathe::getRingDetail() const {
		return ringDetail;
	}

	inline void ProtoLathe::setRingCount(int ringCount) {
		this->ringCount = ringCount;
		update();
	}

	inline int ProtoLathe::getRingCount() const {
		return ringCount;
	}
